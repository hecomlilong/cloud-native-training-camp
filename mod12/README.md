...
MOD=mod12 SURFIX=service-1 MAIN_FILE=service1.go make docker-push
...
MOD=mod12 SURFIX=service-2 MAIN_FILE=service2.go make docker-push
...
MOD=mod12 SURFIX=service-3 MAIN_FILE=service3.go make docker-push
```
